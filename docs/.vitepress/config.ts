...
export default defineConfig({
  title: "Kitbag Access | Type safe attribute-based access control flow",
  description: "Type safe attribute-based access control flow",
  head: [['link', { rel: 'icon', href: '/favicon.ico' }]],
  themeConfig: {
    logo: '/kitbag-logo-circle.svg',
    siteTitle: 'Kitbag Access',

    editLink: {
      pattern: 'https://github.com/kitbagjs/access/edit/main/docs/:path',
    ...
    socialLinks: [
      ...
      { icon: 'github', link: 'https://github.com/kitbagjs/access' },
      { icon: 'discord', link: 'https://discord.gg/zw7dpcc5HV' },
      { icon: 'npm', link: 'https://www.npmjs.com/package/@kitbag/access' },
    ]
  }
})
